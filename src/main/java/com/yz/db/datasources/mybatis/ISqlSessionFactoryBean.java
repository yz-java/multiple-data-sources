package com.yz.db.datasources.mybatis;
 ...
 *         create by 17/11/8
 */
public class ISqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
